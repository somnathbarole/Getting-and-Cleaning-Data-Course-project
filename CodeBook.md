...
TidyData: Tidy data set with average of each variable for each activity and each subject; dimensions 180 x 88. Note that measurements with string mean(), Mean and std in the feature names are extracted.
